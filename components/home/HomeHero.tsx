...
export function HomeHero() {
  ...
  return (
    <div className="relative w-full aspect-[21/9] rounded-[2rem] overflow-hidden bg-[#2563EB] shadow-2xl group border-4 border-white">
      ...
      <div className="absolute inset-0 flex items-center px-12 sm:px-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-8 items-center">
            ...
            <div className="text-white space-y-4">
                <div className="inline-block bg-white text-[#2563EB] px-4 py-1 rounded-full font-black text-2xl rotate-[-2deg] shadow-lg">
                    2K9
                </div>
                ...
                <div className="bg-[#FEE715] text-[#2563EB] py-1 px-4 inline-block font-black skew-x-[-10deg]">
                    TOÁN - LÝ - HÓA - ANH
                </div>
                <p className="text-sm font-bold opacity-90 uppercase tracking-widest max-w-sm">
                    Luyện thi tốt nghiệp THPT cùng thatdehoctoan
                </p>
            </div>
                ...
                {teachers.map((t) => (
                    <div key={t.name} className="flex flex-col items-center group/card cursor-pointer">
                        <div className="relative w-full aspect-[3/4] bg-white/10 rounded-2xl border border-white/20 overflow-hidden transition-all group-hover/card:bg-white/20 group-hover/card:scale-105">
                            ...
                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#2563EB] to-transparent p-2 text-center">
