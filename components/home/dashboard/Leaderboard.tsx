...
export function Leaderboard() {
  return (
    ...
    //           <div className="w-8 h-8 rounded-xl bg-white/10 flex items-center justify-center font-black text-xs border border-white/10">
    //             #6
    //           </div>
    ...
    //         Cố lên! Chỉ cần{" "}
    //         <span className="text-white font-black">1 bài tập nữa</span> để vượt
    //         qua Hoàng Long!
    //       </p>
    //     </div>
    //   </div>
