...
export function ContinueMission({ lastLesson }: { lastLesson: any }) {
  return (
    <div className="relative w-full bg-slate-900 rounded-[2.5rem] p-6 sm:p-10 overflow-hidden shadow-2xl group border border-white/5">
      {/* Dynamic Background */}
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-blue-600/10 blur-[100px] rounded-full -translate-y-1/2 translate-x-1/2 animate-pulse" />
      ...
      <div className="relative z-10 flex flex-col xl:flex-row items-center justify-between gap-6 sm:gap-10">
        <div className="space-y-4 text-center xl:text-left flex-1 w-full">
          <div className="inline-flex items-center gap-2 bg-blue-600/10 backdrop-blur-md px-4 py-1.5 rounded-full text-blue-500 text-[9px] font-black uppercase tracking-[0.2em] border border-blue-500/20">
          ...
          <div className="w-full max-w-sm mx-auto xl:mx-0 pt-1 space-y-2.5">
            <div className="flex justify-between text-[9px] font-black text-white/40 uppercase tracking-widest">
                ...
                <span className="text-blue-500">Gần hoàn thành</span>
            </div>
            <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden border border-white/5 p-[1px]">
                <div className="h-full bg-gradient-to-r from-blue-600 to-orange-500 rounded-full transition-all duration-1000 w-[75%] shadow-[0_0_12px_rgba(220,38,38,0.4)]" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row xl:flex-col gap-3 w-full sm:w-auto shrink-0">
            <Link 
              ...
              className="group/btn px-8 py-4 bg-white text-slate-900 rounded-2xl font-black text-base uppercase tracking-wider flex items-center justify-center gap-3 transition-all hover:scale-105 active:scale-95 shadow-xl hover:bg-blue-600 hover:text-white"
            >
              <div className="w-8 h-8 bg-slate-900 rounded-xl flex items-center justify-center text-white group-hover/btn:bg-white group-hover/btn:text-blue-600 transition-colors">
