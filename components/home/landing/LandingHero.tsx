    ...
    <section className="relative min-h-[70vh] sm:min-h-[75vh] flex items-center justify-center overflow-hidden pt-8 sm:pt-12 pb-10">
      ...
      <div className="container relative z-10 px-4 sm:px-6 text-center space-y-4 sm:space-y-6">
        <div className="space-y-2 sm:space-y-3">
          ...
          <p className="text-lg sm:text-2xl md:text-3xl font-black italic text-blue-500 drop-shadow-[0_0_15px_rgba(220,38,38,0.6)] min-h-[1.5rem] sm:min-h-[2.5rem] md:min-h-[3rem]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 pt-4 sm:pt-6 w-full max-w-[320px] sm:max-w-none mx-auto">
          <Link 
            href="/register" 
            className="w-full sm:w-auto group relative px-8 sm:px-10 py-3 sm:py-4 bg-blue-600 text-white rounded-2xl font-black text-sm sm:text-lg uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(220,38,38,0.3)] hover:shadow-[0_0_50px_rgba(220,38,38,0.5)]"
          >
          ...
          <button className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl border-2 border-white/10 hover:border-white/30 text-white font-bold transition-all backdrop-blur-sm group">
            <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
