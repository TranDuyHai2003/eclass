...
export function LandingPage({ courses }: { courses: LandingCourse[] }) {
  return (
    <div className="min-h-screen bg-[#0F172A] text-white selection:bg-red-500/30">
      ...
      <main className="container mx-auto py-20 px-6 sm:px-8 space-y-32">
        {/* Exhibition Zone (Trưng Bày Vũ Khí) */}
        <section className="space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-4xl font-black uppercase tracking-tighter">Kho Vũ Khí Tri Thức</h2>
            <p className="text-gray-400 max-w-xl mx-auto">Chọn lộ trình của bạn và bắt đầu chinh phục những đỉnh cao mới.</p>
          </div>
