...
import { RANK_THEMES } from "@/lib/game-rank";
    ...
    <div className="relative overflow-hidden rounded-none sm:rounded-2xl bg-[#0D121D]/90 backdrop-blur-xl border-y sm:border border-slate-800 text-white p-4 sm:p-6 shadow-2xl group w-full min-w-0 max-w-full space-y-4 sm:space-y-6">
      ...
      <div className="relative z-10 space-y-4 sm:space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {/* Rank Badge */}
            <span className={`text-xs sm:text-sm lg:text-base font-black px-3.5 py-1.5 rounded-full uppercase tracking-wider shadow-md border ${completedTests === 0 || provisionalRank === 'DANGER' ? RANK_THEMES.DANGER.badgeBg : theme.badgeBg}`}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="bg-[#080B12]/95 border-2 border-amber-500/80 p-3 sm:p-4 rounded-2xl shadow-[0_0_20px_rgba(245,158,11,0.25)] flex flex-col items-center sm:items-end justify-center shrink-0 self-start sm:self-auto min-w-[140px]">
            ...
            <span className="text-[9px] sm:text-sm font-mono text-slate-400 mt-0.5">
              Công thức: ĐTB×10 + Bài + Streak×0.5
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 pt-1">
          ...
          <div className="bg-[#080B12]/90 border border-slate-800 p-3 sm:p-4 rounded-xl space-y-1 shadow-sm">
            <span className="text-[11px] sm:text-sm font-mono text-slate-400 uppercase block font-bold">HẠNG LỚP</span>
            <div className="text-base sm:text-xl lg:text-2xl font-mono font-black text-cyan-300">
              {position ? `#${position}` : '—'} <span className="text-xs sm:text-sm text-slate-500 font-normal">/ {totalStudents}</span>
            </div>
          </div>

          {/* Stat 2: Điểm Trung Bình */}
          <div className="bg-[#080B12]/90 border border-slate-800 p-3 sm:p-4 rounded-xl space-y-1 shadow-sm">
            <span className="text-[11px] sm:text-sm font-mono text-slate-400 uppercase block font-bold">ĐIỂM TRUNG BÌNH</span>
            <div className="text-base sm:text-xl lg:text-2xl font-mono font-black text-amber-300">
          ...
          <div className="bg-[#080B12]/90 border border-slate-800 p-3 sm:p-4 rounded-xl space-y-1 shadow-sm">
            <span className="text-[11px] sm:text-sm font-mono text-slate-400 uppercase block font-bold">ĐÃ HOÀN THÀNH</span>
            <div className="text-base sm:text-xl lg:text-2xl font-mono font-black text-emerald-400">
          ...
          <div className="bg-[#080B12]/90 border border-slate-800 p-3 sm:p-4 rounded-xl space-y-1 shadow-sm">
            <span className="text-[11px] sm:text-sm font-mono text-slate-400 uppercase block font-bold">STREAK HỌC TẬP</span>
            <div className="text-base sm:text-xl lg:text-2xl font-mono font-black text-orange-400 flex items-center gap-1.5">
        ...
        <div className="pt-1">
          ...
          <div className="space-y-2.5 bg-[#080B12] border border-slate-800 p-4 sm:p-5 rounded-xl backdrop-blur-md">
            <div className="flex items-center justify-between text-xs sm:text-base lg:text-lg font-black">
            ...
            <div className="flex items-center justify-between text-xs sm:text-base font-mono text-amber-300 font-bold">
        ...
        <div className="flex items-center justify-between text-xs sm:text-base lg:text-lg pt-2 border-t border-slate-800 text-slate-200">
          <div className="flex items-center gap-2 text-amber-400 font-black">
            <Flame className="w-5 h-5 sm:w-6 sm:h-6 text-orange-500 fill-orange-500 animate-bounce" />
