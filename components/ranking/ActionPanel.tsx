...
export function ActionPanel({
  ...
  // Fallback defaults if backend props not provided or empty
  const supportList = studentsNeedingSupport.length > 0
    ? studentsNeedingSupport
    : [
        { id: "1", name: "Nguyễn Văn Hùng", avgScore: 5.2, reason: "Giảm 3 bậc hạng & nghỉ làm bài 4 ngày" },
        { id: "2", name: "Trần Thị Hoa", avgScore: 5.8, reason: "Điểm 2 bài gần nhất tụt dưới 5.0" },
        { id: "3", name: "Lê Hoàng Nam", avgScore: 4.9, reason: "Chưa hoàn thành số bài thi tối thiểu (2/5)" },
      ];

  const progressList = topProgressingStudents.length > 0
    ? topProgressingStudents
    : [
        { id: "1", name: "Phạm Văn Minh", avgScore: 8.4, rankIncreased: 8, scoreBoost: 1.4 },
        { id: "2", name: "Đỗ Thu Trang", avgScore: 7.9, rankIncreased: 5, scoreBoost: 1.1 },
        { id: "3", name: "Vũ Hải Đăng", avgScore: 8.8, rankIncreased: 4, scoreBoost: 0.9 },
      ];
