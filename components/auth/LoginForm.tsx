    ...
    <div className="mt-8 space-y-6">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-semibold text-gray-700 shadow-sm transition-all duration-200 hover:bg-gray-50 hover:text-gray-900 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#1877F2] px-4 py-3 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:bg-[#166fe5] focus:ring-2 focus:ring-[#1877F2] focus:ring-offset-2"
        >
