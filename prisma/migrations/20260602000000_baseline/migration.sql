...
-- CreateEnum
CREATE TYPE "StudentType" AS ENUM ('ONLINE', 'OFFLINE');
...
-- CreateEnum
CREATE TYPE "HomeworkStatus" AS ENUM ('PENDING', 'SATISFACTORY', 'UNSATISFACTORY');
...
CREATE TABLE "User" (
    ...
    "studentType" "StudentType" NOT NULL DEFAULT 'ONLINE',
...
-- CreateIndex
CREATE INDEX "HomeworkSubmission_lessonId_idx" ON "HomeworkSubmission"("lessonId");

-- CreateIndex
CREATE UNIQUE INDEX "HomeworkSubmission_userId_lessonId_key" ON "HomeworkSubmission"("userId", "lessonId");
