            ...
            <div className="flex-1 space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                ...
                <p className="text-sm sm:text-lg text-slate-400 font-medium max-w-2xl mx-auto lg:mx-0 leading-relaxed uppercase tracking-tight animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
                  Chương trình giảng dạy chuyên sâu, hệ thống bài tập phong phú
                  giúp bạn làm chủ hoàn toàn kiến thức{" "}
                  {c.category?.name?.toLowerCase() || "toán học"}.
                </p>
              </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="prose prose-slate max-w-none prose-p:text-slate-600 prose-p:leading-relaxed prose-p:font-medium prose-p:text-base">
                        {c.description ? (
                          ...
                          <p>
                            Khóa học hiện đang trong quá trình cập nhật nội dung
                            chi tiết. Vui lòng quay lại sau.
                          </p>
                        )}
                      </div>
                    </div>
                          ...
                          <div className="flex items-center gap-5 text-center sm:text-left flex-col sm:flex-row">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-slate-500 font-medium uppercase tracking-tight">
                                Đánh giá năng lực và nhận chứng chỉ hoàn thành
                              </p>
                            </div>
                          </div>
                          <Link
                    ...
                    <div className="flex flex-col md:flex-row gap-10 items-start">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="prose prose-slate max-w-none prose-p:text-slate-600 prose-p:text-sm prose-p:leading-relaxed">
                          <p>
                            Với hơn 10 năm kinh nghiệm trong lĩnh vực giảng dạy
                            và ôn luyện thi Đại học, thầy luôn tâm niệm mang đến
                            những phương pháp giải toán đột phá, tư duy hiện đại
                            và sự truyền cảm hứng mạnh mẽ cho từng học viên.
                          </p>
                          <p>
                            Hệ thống bài giảng và đề thi được biên soạn tỉ mỉ,
                            giúp học sinh nắm vững kiến thức trọng tâm.
                          </p>
                        </div>
                        <div className="flex gap-4 pt-2">
                          {[
                            ...
                            <div
                              key={i}
                              className="text-center px-4 py-2 bg-slate-50 rounded-xl border border-slate-100"
                            >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-baseline gap-3">
                        ...
                        {(c.price ?? 0) > 0 && (
                          <span className="text-base text-slate-300 font-bold line-through tracking-tight">
                            {((c.price || 0) * 1.5).toLocaleString()}đ
                          </span>
                        )}
                      </div>
                    </div>
        ...
        <div className="bg-slate-900/95 backdrop-blur-2xl rounded-[2.5rem] p-2.5 shadow-[0_20px_50px_rgba(0,0,0,0.4)] border border-white/10 flex items-center gap-3">
          ...
          <div className="flex-1 flex flex-col pl-1">
            ...
            <span className="text-sm font-black text-white mt-1">
              {(c.price || 0) > 0 ? `${c.price!.toLocaleString()}đ` : "Miễn phí"}
            </span>
          </div>
