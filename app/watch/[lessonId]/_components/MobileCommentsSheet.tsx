  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <button className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest">
        ...
        <div className="flex flex-col h-full bg-white">
          <SheetHeader className="px-4 py-3 border-b border-slate-100">
            <SheetTitle className="flex items-center gap-2 text-sm font-black uppercase tracking-tight text-slate-900">
              ...
              Thảo luận
              <span className="ml-auto px-2 py-0.5 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-black">
                {commentCount}
              </span>
            </SheetTitle>
          </SheetHeader>
